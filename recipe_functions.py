...
def calculateCalories(calories, grams): #function to calculate calories - calculated by the amount of calories whilst the grams is a percentage because all ingredients macros are based on 100g
    result = calories * grams / 100
    return result            
